...
<div class="container">
	<div class="row">
        ...
        <div class="col-lg-5">
            <input type="search" class="form-control" ng-model="search.nombre" id="busquedanombre" placeholder="Buscar por animal..." >
        </div>
        <div class="col-lg-5">
            <input type="search" class="form-control" id="input-search-owner" placeholder="Buscar por dueño..." >
        </div>
        ...
        <div id="resultado" ng-controller='BuscadorAngular'>
              <div ng-repeat="f in listaBusqueda | filter:search">
                <a href= "{{f.url}}">             
